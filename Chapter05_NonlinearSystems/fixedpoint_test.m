% Test for "fixedpoint.m"
% 10170437 Mark Taylor

function fixedpoint_test()
% Here's an example:
...
phi1=@(x) x^2+x-3;
fprintf('/***phi1(x)\n')
[x1,k1]=fixedpoint(phi1,x0)
fprintf('***/end of phi1(x)\n\n\n')

phi2=@(x) 3/x;
fprintf('/***phi2(x)\n')
[x2,k2]=fixedpoint(phi2,x0)
fprintf('***/end of phi2(x)\n\n\n')

phi3=@(x) x-1/4*(x^2-3);
fprintf('/***phi3(x)\n')
[x3,k3]=fixedpoint(phi3,x0)
fprintf('***/end of phi3(x)\n\n\n')

phi4=@(x) 1/2*(x+3/x);
fprintf('/***phi4(x)\n')
[x4,k4]=fixedpoint(phi4,x0)
...
fprintf('For x1=5.7\n')
[x31,k31]=fixedpoint(phi3,5.7)
fprintf('\n\nFor x2=5.8\n')
[x32,k32]=fixedpoint(phi3,5.8)
