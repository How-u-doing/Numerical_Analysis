...
% Find a polynomial H(x) of£¨2m-1)-th degree that goes through a set of points that  
% are in the  m-by-3  table and with the same  derivatives as f(x) at those points.
