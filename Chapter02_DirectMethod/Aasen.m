...
for i=1:n-2
    ...
    % Perform Gaussian elimination and store the multipliers i.e. l_ijs in the 
    % lower & upper triangular part of A so that the permutations of L(r+2:n,i) 
    % and L(r+2:n,i).' will be implemented as the pivoting process goes on.
