...
\begin{document}
	...
	\begin{figure}[!hb]
		\makebox[\textwidth][c]{			
			\subfloat[Fitting for problem 1
			]{\includegraphics[width=0.47\paperwidth]{svg/problem_1}}
			\subfloat[Problem 1 roomed in 
			]{\includegraphics[width=0.47\paperwidth]{svg/problem_1_zoomed_in}
				}}	
		\caption{BVP Test 1}
	\end{figure}
	...
	\begin{figure}[!hb]
		\makebox[\textwidth][c]{			
			\subfloat[Fitting for problem 2
			]{\includegraphics[width=0.47\paperwidth]{svg/problem_2}}
			\subfloat[Problem 2 roomed in 
			]{\includegraphics[width=0.47\paperwidth]{svg/problem_2_zoomed_in}
		}}	
		\caption{BVP Test 2}
	\end{figure}
